...
use crate::authorship::stats::{
    DetailedCommitStats, FileStats, accepted_lines_from_attestations, stats_for_commit_detailed,
    ...
    let file_stats = diff_ai_stats
        ...
        .map(|(file_path, file)| {
            (
                file_path,
                FileStats {
                    human_additions: file.human_additions,
                    unknown_additions: file
                        .added_lines
                        .saturating_sub(file.ai_accepted)
                        .saturating_sub(file.human_additions),
